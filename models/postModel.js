...
const CommentSchema = new mongoose.Schema({
  ...
  createdBy: { type: mongoose.Schema.Types.ObjectId, ref: "User", required: true }, // Reference to the user who made the comment
  ...
  replies: [
    {
      ...
      createdBy: { type: mongoose.Schema.Types.ObjectId, ref: "User", required: true }, // User who replied
